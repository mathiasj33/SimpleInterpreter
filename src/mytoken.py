...
TokenType = Enum('TokenType',
                 'PLUS MINUS MUL DIV POW NUMBER LPAREN RPAREN EOL IDENT IF ELSE WHILE LBRACE RBRACE ASSIGN TRUE FALSE EQUAL L LE G GE AND OR NOT FUN RET COMMA STRING HASH DOT')
